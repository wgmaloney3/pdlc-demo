      ...
      <Card className="border-0 shadow-xl shadow-black/10 ring-1 ring-border/60">
        <CardHeader className="space-y-2 pb-3 sm:space-y-3 sm:pb-4 lg:px-8 lg:pb-6 lg:pt-8">
          ...
          <CardDescription className="text-base leading-relaxed sm:text-lg lg:text-xl lg:leading-relaxed">
            Sign in to continue to your saved homes and preferences.
          </CardDescription>
        </CardHeader>
        <CardContent className="lg:px-8 lg:pb-8">
          ...
          >
            <div className="space-y-2 sm:space-y-2.5 lg:space-y-3">
              <Label htmlFor="email" className="text-sm font-medium sm:text-base lg:text-lg">
                Email
              </Label>
              <Input
                id="email"
            ...
            <div className="space-y-2 sm:space-y-2.5 lg:space-y-3">
              <Label htmlFor="password" className="text-sm font-medium sm:text-base lg:text-lg">
                Password
              </Label>
              <Input
                id="password"
